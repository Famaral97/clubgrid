...
def upgrade() -> None:
    ...
    op.add_column('grids', sa.Column('type_id', sa.Integer(), nullable=True))

    op.create_foreign_key('grids_ibfk_7', 'grids', 'grid_types', ['type_id'], ['id'])
