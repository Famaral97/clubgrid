...
def create_default_conditions(db, app):
    conditions = [
        ...
        Condition(id=21, description="Logo doesn't have numners", expression="clubs.numbers = False"),
        ...
        Condition(id=32, description="Never won UEFA Champions League/European Cup", expression="clubs.champions_league_titles = 0"),
        Condition(id=33, description="Won UEFA Champions League/European Cup", expression="clubs.champions_league_titles > 0"),
        Condition(id=34, description="Was UEFA Champions League/European Cup Runner-Up", expression="clubs.champions_league_runner_up > 0"),
        Condition(id=35, description="Was in UEFA Champions League/European Cup Final", expression="(clubs.champions_league_titles > 0 or clubs.champions_league_runner_up > 0)"),

        Condition(id=36, description="Never won UEFA Europa League/UEFA Cup", expression="clubs.europa_league_titles = 0"),
        Condition(id=37, description="Won UEFA Europa League/UEFA Cup", expression="clubs.europa_league_titles > 0"),
        Condition(id=38, description="Was UEFA Europa League/UEFA Cup Runner-Up", expression="clubs.europa_league_runner_up > 0"),
        Condition(id=39, description="Was in UEFA Europa League/UEFA Cup Final", expression="(clubs.europa_league_titles > 0 or clubs.europa_league_runner_up > 0)"),
