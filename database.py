...
def create_default_conditions(db, app):
    conditions = [
        ...
        Condition(id=34, description="Was UEFA Champions League / European Cup Runner-Up",
                  expression="clubs.champions_league_runner_up > 0", tags="titles"),
        Condition(id=35, description="Was in UEFA Champions League / European Cup Final",
                  expression="(clubs.champions_league_titles > 0 or clubs.champions_league_runner_up > 0)", tags="titles"),

        Condition(id=36, description="Never won UEFA Europa League / UEFA Cup",
                  expression="clubs.europa_league_titles = 0", tags="titles"),
        ...
        Condition(id=38, description="Was UEFA Europa League / UEFA Cup Runner-Up",
                  expression="clubs.europa_league_runner_up > 0", tags="titles"),
        Condition(id=39, description="Was in UEFA Europa League / UEFA Cup Final",
                  expression="(clubs.europa_league_titles > 0 or clubs.europa_league_runner_up > 0)", tags="titles"),
        ...
        Condition(id=47, description="Won a domestic Cup", expression="clubs.cup_titles > 0", tags="titles"),
        Condition(id=48, description="Won domestic Cup 5 or more times", expression="clubs.cup_titles >= 5", tags="titles"),
