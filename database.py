...
def create_default_conditions(db, app):
    conditions = [
        ...
        Condition(id=81, description="Has at least 5 league titles", expression="clubs.league_titles > 4",
        ...
        Condition(id=44, description="Logo is circular", expression="clubs.logo_is_circular = True", tags="logo-items"),
        ...
        Condition(id=104, description="In 2024/25 UEFA Champions League",
